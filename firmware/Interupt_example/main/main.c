...
#define LED_GPIO GPIO_NUM_46       // Pushbutton GPIO

#define BUTTON_GPIO GPIO_NUM_9       // Pushbutton GPIO
...
void app_main(void) {
    ...
    gpio_config_t led_conf = {
        .intr_type = GPIO_INTR_DISABLE, // Rising edge interrupt trigger
    ...
    while (1) {
        ...
        if (xQueueReceive(button_queue, &button_counter, 0)) {
